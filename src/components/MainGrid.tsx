...
const MainGrid: React.FC<MainGridProps> = ({ input }) => {
  ...
  const getDirectionIcon = (direction: "NORTH" | "EAST" | "SOUTH" | "WEST") => {
    switch (direction) {
      case "NORTH":
        return <ArrowUpward sx={{ color: "primary.main" }} />;
      case "SOUTH":
        return <ArrowDownward sx={{ color: "primary.main" }} />;
      case "EAST":
        return <ArrowForward sx={{ color: "primary.main" }} />;
      case "WEST":
        return <ArrowBack sx={{ color: "primary.main" }} />;
      default:
        return null;
    }
  };
